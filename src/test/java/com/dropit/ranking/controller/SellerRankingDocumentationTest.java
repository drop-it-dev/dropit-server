    ...
    void getRanking() throws Exception {
        ...
        mockMvc.perform(get("/rankings/sellers")
                ...
                .andDo(document("seller-rankings-get", resource(builder()
                        ...
                        .queryParameters(
                        ...
                        ).responseSchema(new Schema("SellerRankingResponse")).responseFields(
                                ...
                                fieldWithPath("requestedSeller.rank").type(NUMBER).description("요청 판매자의 순위"),
                                fieldWithPath("requestedSeller.sellerId").type(NUMBER).description("요청 판매자 ID"),
                                fieldWithPath("requestedSeller.salesQuantity").type(NUMBER).description("요청 판매자의 판매 수량")
                        ).build())));
    }
}
